  ...
  while (true) {
    ...
    for (const source of sources) {
      ...
      const page: RegulatoryPage = {
        ...
        regulatory_body: (source.regulatory_body ?? 'CFSA') as RegulatoryPage['regulatory_body'],
...
async function reScrapeShortContent() {
  ...
  // Find sources with scrape_status='scraped' that have short content
