export function buildOpenApiSpec() {
  return {
    openapi: '3.1.0',
    info: {
      title: 'Taama AU — Australia & New Zealand Regulatory Compliance API',
      version: '1.0.0',
      description:
        'REST API for querying Australia and New Zealand regulatory compliance data — ingredients, claims, labelling, import requirements, and regulatory changes.',
    },
    servers: [{ url: 'https://sieve-mcp-au.vercel.app' }],
    security: [{ apiKey: [] }],
    components: {
      securitySchemes: {
        apiKey: {
    ...
    paths: {
      '/api/v1/check-ingredient': {
        post: {
          ...
          description:
            'Check if an ingredient is permitted, restricted, or banned in Australia and New Zealand for a given product category.',
          requestBody: {
            required: true,
            content: {
              'application/json': {
                schema: {
                  ...
                  properties: {
                    ...
                    product_category: {
                      type: 'string' as const,
                      description: 'Product category (e.g. food, cosmetics, supplements, beverages)',
                    },
                    concentration_pct: {
              ...
              content: {
                'application/json': {
                  example: {
                    ...
                    max_concentration_pct: 0.07,
                    max_daily_dose_mg: null,
                    conditions: [],
                    required_warnings: ['Contains tartrazine'],
                    regulation_reference: 'FSANZ Standard 1.3.1 Schedule 15',
      ...
      '/api/v1/validate-claims': {
        post: {
          ...
          description: 'Validate product claims against Australia and New Zealand regulations.',
          requestBody: {
            required: true,
            content: {
              'application/json': {
                    ...
                    results: [
                      {
                        ...
                        regulation_reference: 'FSANZ Standard 1.2.7',
      ...
      '/api/v1/labelling-requirements': {
        get: {
          ...
          description: 'Get mandatory and optional labelling requirements for products in Australia and New Zealand.',
          parameters: [
            {
                    ...
                    elements: [
                      {
                        ...
                        exemptions: null,
                        regulation_reference: 'FSANZ Standard 1.2.1',
                      },
                    ],
                  },
                },
      ...
      '/api/v1/import-requirements': {
        get: {
          ...
          description: 'Get import requirements for products entering Australia and New Zealand.',
          parameters: [
            {
              name: 'product_category',
              in: 'query' as const,
              ...
              content: {
                'application/json': {
                  example: {
                    ...
                    requirements: [
                      {
                        requirement: 'DAFF Import Permit',
                        requirement_type: 'permit',
                        regulatory_body: 'DAFF',
                        documents_required: ['Import permit application', 'Certificate of analysis'],
                        special_conditions: null,
                        regulation_reference: 'Biosecurity Act 2015',
                      },
                    ],
                  },
                },
      ...
      '/api/v1/regulation-update': {
        get: {
          ...
          description: 'Get recent regulatory changes detected in Australia and New Zealand.',
          parameters: [
            {
              name: 'since',
              in: 'query' as const,
                    ...
                    changes: [
                      {
                        ...
                        change_summary: 'Updated food additive limits in Schedule 15',
      ...
      '/api/v1/search-regulations': {
        get: {
          ...
          description:
            'Semantic search over Australia and New Zealand regulatory content using vector similarity, with full-text search fallback.',
          parameters: [
            {
              name: 'query',
              in: 'query' as const,
              ...
              example: 'food additives permitted Schedule 15',
            },
            {
              name: 'limit',
              in: 'query' as const,
              ...
              content: {
                'application/json': {
                  example: {
                    ...
                    results: [
                      {
                        chunk_text: 'The following food additives are permitted under FSANZ Schedule 15...',
                        source_url: 'https://www.legislation.gov.au/F2015L00439/latest/text',
      ...
      '/api/v1/trigger-scrape': {
        post: {
          ...
          description:
            'Trigger a scrape of Australia and New Zealand regulatory sources. Admin-only — runs full ingestion, change detection, or specific URL scraping.',
          requestBody: {
            required: true,
            content: {
              'application/json': {
      ...
      '/api/v1/ingestion-status': {
        get: {
          ...
          description: 'Get the status of the Australia and New Zealand regulatory data ingestion pipeline.',
          parameters: [],
          responses: {
            '200': {
