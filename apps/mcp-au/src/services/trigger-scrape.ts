...
export const triggerScrapeSchema = z.object({
  mode: z
    .enum(['full', 'change_detection', 'specific_urls', 'seed', 'structure_remaining', 're_structure', 're_scrape_short_content', 'scrape_pending'])
  ...
  while (true) {
    ...
    for (const source of sources) {
      ...
      const page: RegulatoryPage = {
        ...
        regulatory_body: (source.regulatory_body ?? 'FSANZ') as RegulatoryPage['regulatory_body'],
