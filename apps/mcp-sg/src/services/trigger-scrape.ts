...
export const triggerScrapeSchema = z.object({
  mode: z
    .enum(['full', 'change_detection', 'specific_urls', 'seed', 'structure_remaining', 're_structure', 'scrape_pending'])
  ...
  while (true) {
    ...
    for (const source of sources) {
      ...
      const page: RegulatoryPage = {
        ...
        regulatory_body: (source.regulatory_body ?? 'SFA') as RegulatoryPage['regulatory_body'],
