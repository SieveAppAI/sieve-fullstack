export function buildOpenApiSpec() {
  return {
    ...
    servers: [{ url: 'https://sieve-mcp-sg.vercel.app' }],
    security: [{ apiKey: [] }],
    components: {
      securitySchemes: {
        apiKey: {
    ...
    paths: {
      ...
      '/api/v1/validate-claims': {
        post: {
          ...
          description: 'Validate product claims against Singapore regulations.',
          requestBody: {
            required: true,
            content: {
              'application/json': {
                    ...
                    results: [
                      {
                        ...
                        regulation_reference: 'Singapore Food Regulations',
      ...
      '/api/v1/labelling-requirements': {
        get: {
          ...
          description: 'Get mandatory and optional labelling requirements for products in Singapore.',
          parameters: [
            {
      ...
      '/api/v1/import-requirements': {
        get: {
          ...
          description: 'Get import requirements for products entering Singapore.',
          parameters: [
            {
              name: 'product_category',
              in: 'query' as const,
      ...
      '/api/v1/regulation-update': {
        get: {
          ...
          description: 'Get recent regulatory changes detected in Singapore.',
          parameters: [
            {
              name: 'since',
              in: 'query' as const,
      ...
      '/api/v1/search-regulations': {
        get: {
          ...
          description:
            'Semantic search over Singapore regulatory content using vector similarity, with full-text search fallback.',
          parameters: [
            {
              name: 'query',
              in: 'query' as const,
      ...
      '/api/v1/trigger-scrape': {
        post: {
          ...
          description:
            'Trigger a scrape of Singapore regulatory sources. Admin-only — runs full ingestion, change detection, or specific URL scraping.',
          requestBody: {
            required: true,
            content: {
              'application/json': {
      ...
      '/api/v1/ingestion-status': {
        get: {
          ...
          description: 'Get the status of the Singapore regulatory data ingestion pipeline.',
          parameters: [],
          responses: {
            '200': {
